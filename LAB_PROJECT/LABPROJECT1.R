...
netflix <- netflix_titles[1:1000, ]   # first 1000 rows
write.csv(netflix, "sample_netflix_data.csv", row.names = FALSE)

netflix <- netflix_cleaned[1:1000, ]   # first 1000 rows
write.csv(netflix, "sample_netflix_cleaned_data.csv", row.names = FALSE)
